...
class PromptBuilder:
    ...
    def _build_system_prompt(*, context: dict[str, Any]) -> str:
        ...
        return (
            ...
            "Du hast Zugriff auf: aktuelles Wetter, Haushaltskalender, Fußballdaten (Bundesliga), Kraftstoffpreise. "
            "Diese Daten stehen bereit wenn eine Recherche vorliegt — sage NIEMALS du hättest keine Internetverbindung oder keine Daten, wenn Recherche-Ergebnisse geliefert wurden. "
