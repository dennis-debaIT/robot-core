            ...
            result = LLMRouter().generate(
                {
                    "messages": [
                        {"role": "system", "content": (
                            ...
                            "wieder den Boden zu berühren. Boden-Roboter (Mähroboter, Saugroboter) fahren "
                            "oder rollen — sie schweben oder fliegen nie, auch nicht metaphorisch beim "
                            "Zurückfahren zur Ladestation. "
                            "Der Humor darf die Formulierung würzen, aber NIE die tatsächliche Bedeutung "
                            "des Ereignisses verändern oder durch eine erfundene Handlung/Erklärung "
                            "ersetzen — kein zusätzliches Ölen, Reinigen, Reparieren o.ä. erwähnen, das im "
                            "Ereignis nicht genannt ist, und keine alternative Geschichte erfinden (z.B. "
                            "bedeutet 'Außerhalb Begrenzungsdraht', dass der Mähroboter beim Mähen den "
                            "Begrenzungsdraht verloren hat, nicht dass er irgendwo weggelaufen oder "
                            "geflohen ist). Vermeide Formulierungen, die sich innerhalb eines Satzes "
                            "selbst widersprechen (z.B. nicht 'schleppt sich selbstbewusst'). Schreibe den "
                            "Gerätenamen exakt wie im Ereignis angegeben, inklusive Umlauten. "
