...
class IntegrationConfigService:
    ...
    def default_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "attention": {
                ...
                "proactive_weekday_start": "06:00",
                "proactive_weekday_end": "22:00",
                "proactive_weekend_start": "08:00",
                "proactive_weekend_end": "22:00",
    ...
    def get_config(self) -> dict[str, Any]:
        ...
        energy["show_autarkie"] = bool(energy.get("show_autarkie", True))
        ...
        sync_cfg["enabled"] = bool(sync_cfg.get("enabled", False))
        sync_modules = sync_cfg.setdefault("modules", {})
        sync_modules["shopping"]   = bool(sync_modules.get("shopping",   True))
        sync_modules["notes"]      = bool(sync_modules.get("notes",      False))
        sync_modules["reminders"]  = bool(sync_modules.get("reminders",  False))
        sync_modules["chores"]     = bool(sync_modules.get("chores",     True))
        ...
        sync_modules["calendar"]   = bool(sync_modules.get("calendar",   False))
        sync_modules["lights"]     = bool(sync_modules.get("lights",     False))
        ...
        attention["proactive_weekend_end"] = self._sanitize_time_hhmm(attention.get("proactive_weekend_end"), "22:00")
    ...
    def update_config(self, patch: dict[str, Any]) -> dict[str, Any]:
        ...
        energy_tariffs["extra_fees_eur_year"] = self._sanitize_tariff_eur_year(energy_tariffs.get("extra_fees_eur_year"))
        energy["sensors"] = self._sanitize_energy_sensors(energy.get("sensors"))
        sync_cfg2 = updated.setdefault("sync", {})
        sync_cfg2["enabled"] = bool(sync_cfg2.get("enabled", False))
        sync_modules2 = sync_cfg2.setdefault("modules", {})
        sync_modules2["shopping"]  = bool(sync_modules2.get("shopping",  True))
        sync_modules2["notes"]     = bool(sync_modules2.get("notes",     False))
        sync_modules2["reminders"] = bool(sync_modules2.get("reminders", False))
        sync_modules2["chores"]    = bool(sync_modules2.get("chores",    True))
        ...
        sync_modules2["calendar"]  = bool(sync_modules2.get("calendar",  False))
        sync_modules2["lights"]    = bool(sync_modules2.get("lights",    False))
