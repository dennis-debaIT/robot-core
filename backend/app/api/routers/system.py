...
_LLM_PROVIDERS: dict[str, dict[str, Any]] = {
    "groq":    {"url": "https://api.groq.com/openai/v1/chat/completions",                             "models": ["openai/gpt-oss-20b", "openai/gpt-oss-120b", "llama-3.3-70b-versatile", "gemma2-9b-it", "mixtral-8x7b-32768"]},
